...
let MBDUserLoginViewControllerIdentifier: String = "MBDUserLoginViewController"

class MBDUserLoginWireframe//: StoryboardSegueDelegate
{
	// MARK: - Property

    weak var presenter: MBDUserLoginPresenter? = nil
    private weak var viewController: MBDUserLoginViewController? = nil

    // MARK: - Storyboard segue

    /*    
    enum SegueIdentifier: String {
        case PushTo<# Next interface name #> = "pushMBDUserLoginTo<# Next interface name #>"
    }
    */
    ...
    func presentInterface(fromWindow window: UIWindow)
    {
        ...
        if let viewController = navigationViewController.viewControllers.first as? MBDUserLoginViewController {
    ...
    */
    ...
    private func navigationControllerFromStoryboard() -> UINavigationController
    {
        ...
        let navigationController = storyboard.instantiateViewControllerWithIdentifier(MBDUserLoginViewControllerIdentifier) as! UINavigationController
